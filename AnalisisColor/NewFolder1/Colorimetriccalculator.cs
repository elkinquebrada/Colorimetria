...
namespace ColorimetryApp
{
    // ================================
    // MODELOS DE DATOS
    // ================================
    public sealed class ColorimetricRow
    {
        // Iluminante (D65, TL84, A, etc.)
        ...
        // Ángulo de tono (grados 0..360). Si no lo usas, deja 0.
    ...
    public static class ColorimetricCalculator
    {
        ...
        /// ΔL, Δa, Δb, ΔE*ab (CIE76), ΔChroma, ΔHue (±180°),
        /// y porcentajes de corrección por canal (L/A/B).
        /// </summary>
        public static List<CorrectionResult> Calculate(List<ColorimetricRow> rows)
        {
