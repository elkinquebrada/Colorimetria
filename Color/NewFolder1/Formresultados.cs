...
namespace Colorimetria
{
    public class FormResultados : Form
    {
        ...
        private void InitializeComponents()
        {
            ...
            txtRecomendacion = BuildTextBox(System.Drawing.Color.FromArgb(255, 220, 100)); // ámbar
        ...
        private static TextBox BuildTextBox(Color? foreColor)
        {
            return new TextBox
            {
                Multiline = true,
        ...
        private static string BuildPlanoPolarAdvice(EngineRes r)
        {
            ...
            // Ángulo polar del vector (?a, ?b) y módulo en el plano a*-b*
